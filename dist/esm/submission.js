...
import { EXT_CALL_STORAGE_OFFSET } from "./constants";
...
export class SubmissionState {
        ...
        switch (type) {
            ...
            case UpdateActions.ExternalCallStorage: {
                ...
                if (this.expectedCalldata &&
                    ...
                    this.expectedCalldata.equals(this.externalCallStorage.data.slice(EXT_CALL_STORAGE_OFFSET, ((_v = this.externalCallMeta.data.data) === null || _v === void 0 ? void 0 : _v.accumulation)
                        ? this.externalCallMeta.data.data.accumulation.externalCallLen.toNumber()
                        : this.expectedCalldata.length + EXT_CALL_STORAGE_OFFSET))) {
    ...
    constructor(decoder, connection, submissionId, accounts, logFn, initialState, subscriptionCommitment = "confirmed") {
        ...
        this.confirmationStorage = new UpdatableAccountInfo(accounts.confirmationStorage, null, decoder.decodeConfirmationStorage);
        this.submission = new UpdatableAccountInfo(accounts.submission, null, decoder.decodeSubmissionAccount);
        this.nativeSubscriptions = [
        ...
        if (accounts.externalCall) {
            this.externalCallMeta = new UpdatableAccountInfo(accounts.externalCall.externalCallMeta, null, decoder.decodeExternalCallMeta);
            this.externalCallStorage = new UpdatableAccountInfo(accounts.externalCall.externalCallStorage, null, (data) => Buffer.from(data));
    ...
    getInitialState() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            const [rawConfStorage, rawSubmission, ...rest] = yield this.connection.getMultipleAccountsInfo([
