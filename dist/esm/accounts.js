export function buildDecodedAccountInfoWithAddress(address, info, decoder) {
    return Object.assign(Object.assign({}, info), { address, data: info && (info === null || info === void 0 ? void 0 : info.data.length) !== 0 ? decoder(info.data) : null });
}
export class UpdatableAccountInfo {
